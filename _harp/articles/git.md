...
9. **`git rm`** - удаляет файлы из рабочей директории и из индекса. <sup>[\[4.9\]][4.9]</sup>
...
12. **`git checkout`** - переключается между ветками или восстанавливает файлы в рабочей директории. <sup>[\[4.12\]][4.12]</sup>
